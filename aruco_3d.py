...
if __name__ == "__main__":
    ...
    device_id = "213622250855"  # Lab: "828112071102" home:"829212070352"
    enable_rgb = True
    enable_depth = True
    # Configure streams
    ...
    try:
        ...
        cv2.aruco_dict = cv2.aruco.Dictionary_get(ARUCO_DICT["DICT_4X4_100"])
        ...
        while True:
            ...
            if enable_rgb or enable_depth:
                ...
                markerCorners, markerIds, rejectedCandidates = cv2.aruco.detectMarkers(color_image, cv2.aruco_dict, parameters=parameters)
                ...
                if markerIds is not None:
                    ...
                    for key in key_list:
                        ...
                        cv2.circle(color_image,[int(centre[0]),int(centre[1])],1,(0,0,255),8)
